...
export { ConnectionConfig, ConnectionEvent, ConnectionLabelConfig } from './app/interfaces/config';
export { ConnectionAdded } from './app/interfaces/connection-added';
...
export { ConnectionEndpointConfig, DiagramConfig } from './app/interfaces/diagram-config';
